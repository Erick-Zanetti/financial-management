...
interface FloatingSelectTriggerProps
...
>(({ className, children, label, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "relative group flex h-12 w-full items-center justify-between rounded-lg border border-input bg-transparent px-3 pt-5 pb-1 text-sm shadow-sm ring-offset-background transition-all focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
...
FloatingSelectContent.displayName = "FloatingSelectContent"
